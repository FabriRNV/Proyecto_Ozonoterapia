...
const tabs = ({ simularCarga, nombreTitulo, objetosNav }) => {
  return (
    ...
    <div className="flex flex-col items-center justify-center text-sm font-medium text-center text-cuarto lg:justify-between lg:flex-row mb-3">
      ...
      <ul className="flex flex-wrap -mb-px justify-end lg:order-last">
        {
          ...
          objetosNav?.objetos?.map((objeto, index) => 
            <Tabs 
              ...
              objetoLink={objeto.to}      // URL o ruta asociada con esta pestaña.
